...
/* harmony import */ var _statstidende__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./statstidende */ "./src/site/statstidende.js");
...
const siteBehaviors = [
	...
	_statstidende__WEBPACK_IMPORTED_MODULE_5__.Statstidende,
];
...
class InstagramPostsBehavior extends _lib_behavior__WEBPACK_IMPORTED_MODULE_0__.Behavior {
	...
	async *viewStandalonePost(origLoc) {
		...
		const firstPostHref = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathString)(
		...
		await (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.waitUntil)(
			() => (root2 = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(this.rootPath)) !== root && root2,
			_lib_utils__WEBPACK_IMPORTED_MODULE_1__.waitUnit * 5
		);
		...
		await (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.waitUntil)(
			() => (root3 = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(this.rootPath)) !== root2 && root3,
			_lib_utils__WEBPACK_IMPORTED_MODULE_1__.waitUnit * 5
		);
		//}
	}
	...
	async *iterPosts(next) {
		...
		while (next && ++count <= 3) {
			...
			await Promise.race([this.iterComments(), (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.sleep)(this.maxCommentsTime)]);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Statstidende": () => (/* binding */ Statstidende)
/* harmony export */ });
/* harmony import */ var _lib_behavior__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../lib/behavior */ "./src/lib/behavior.js");
/* harmony import */ var _lib_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../lib/utils */ "./src/lib/utils.js");


class Statstidende extends _lib_behavior__WEBPACK_IMPORTED_MODULE_0__.Behavior {
	static isMatch() {
		return window.location.href.match(
	...
	async *iterPages() {
		let button = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(this.nextButtonXPath);
		while (button != null) {
			button.click();
			await (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.sleep)(_lib_utils__WEBPACK_IMPORTED_MODULE_1__.waitUnit * 10);
			button = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(this.nextButtonXPath);
			yield;
		}
	}
	...
	async *iterDownloads() {
		for (let index = 1; index <= 10; index++) {
			const node = (0,_lib_utils__WEBPACK_IMPORTED_MODULE_1__.xpathNode)(
...
var map = {
	...
	"./site/statstidende": "./src/site/statstidende.js",
	"./site/statstidende.js": "./src/site/statstidende.js",
